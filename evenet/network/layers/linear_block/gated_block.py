...
class GatedBlock(nn.Module):
    ...
    def __init__(self, options: DotDict, input_dim: int, output_dim: int, skip_connection: bool = False):
        ...
        self.activation = create_activation(options.Network.linear_activation, self.hidden_dim)

        # Create normalization layer for keeping values in good ranges.
        self.normalization = create_normalization(options.Network.normalization, output_dim)

        # Optional dropout for regularization.
        self.dropout = create_dropout(options.Network.dropout)
