...
from evenet.network_scratch.heads.assignment.symmetric_attention import SymmetricAttentionSplit, SymmetricAttentionFull
from evenet.network_scratch.heads.classification.classification_head import BranchLinear
