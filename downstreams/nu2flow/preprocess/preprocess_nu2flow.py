...
from downstreams.nu2flow.preprocess.convertor import convert_nu2flow
...
def preprocess(in_dir, store_dir, process_info, unique_id, cfg_dir=None, save: bool = True):
    ...
    for process in global_config.process_info:
        ...
        matched_data = convert_nu2flow(matched_data)
        ...
        # sources['sources-0-mask'] = converter.raw_data['INPUTS/Source/MASK']
        ...
        invisible = converter.load_invisible(max_num_neutrinos=2, direct_from_spanet=True)
